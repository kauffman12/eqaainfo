...
IGNORE_LIST = [ 'MRC -', 'AVCReserved', '- RESERVED', 'AB-Test-TAB', 'SumUNMm', 'Brittle Haste', 'SKU', 'Type 3', 'Type3', 'ShapeChange', 'BETA', 'Beta', 'ABTest', ' Test', ' test ', 'Test1', 'Test2', 'Test3', 'Test4', 'Test5', 'N/A', 'NA ', 'TEST ', 'PH', 'Placeholder' ]
...
ADPS_TANK = [ 55, 69, 114, 175, 178, 197, 323, 393, 450, 451, 452, 515, 516 ]
...
if os.path.isfile(DBSpellsFile):
  ...
  for spellId in sorted(myDB.keys()):
    ...
    if spellInfo['bane'] == True:
      ...
      proc = 1
    elif spellInfo['level'] == 255 and spellInfo['skill'] == 52 and not inNotProcList(spellInfo['abbrv']):
      proc = 1
